...
public class TransferRepository extends GenericRepository<Transfer, Long> {
    ...
    public List<Transfer> findAll() {
        return entityManager
                .createNamedQuery("Transfer.findAll", Transfer.class)
                .getResultList();
    }

    public Optional<Transfer> findById(long id) {
        return entityManager
                .createNamedQuery("Transfer.findById", Transfer.class)
                .getResultList()
                .stream().findFirst();
    }
    ...
    public List<Transfer> findBySourceDeposit(String sourceDeposit) {
        return entityManager
                .createNamedQuery("Transfer.findBySourceDeposit", Transfer.class)
    ...
    public List<Transfer> findByDestinationDeposit(String destinationDeposit) {
        return entityManager
                .createNamedQuery("Transfer.findByDestinationDeposit", Transfer.class)
